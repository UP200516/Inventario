...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Policarbonato</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href=" {{ route('dashboard') }} ">Home</a></li>
                    <li class="breadcrumb-item active">Editar policarbonato</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <h5 class="card-title">Editar policarbonato</h5>
                        <br>
                        <!-- form start -->
                        <form role="form" action="{{ route('polycarbonates.update', $polycarbonate->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
