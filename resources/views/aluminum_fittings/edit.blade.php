        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Editar herrajes para aluminio</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <h5 class="card-title">Editar herraje de aluminio</h5>
                        <br>
                        <!-- form start -->
                        <form role="form" action="{{ route('aluminum_fittings.update', $aluminum_fitting->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
